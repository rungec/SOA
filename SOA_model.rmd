...
print(anova(mod1$lme, mod2a$lme)) #any difference?
acfplotfun(mod2a) #any correlation remaining?

#compare mod1 and mod2
comparemodelsplot(mod1$gam, mod2a$gam)
...
```{r growthrates, include=FALSE, eval=FALSE, cache=T, dependson=c("packages and data", "merge data")}
...
```{r plot growthrates, echo=FALSE, warning=FALSE, eval=FALSE, include=FALSE, cache=T, dependson=c("packages and data", "merge data", "growthrates")}
...
```{r modelsold, echo=FALSE, eval=FALSE, include=FALSE, warning=FALSE, cache=T, dependson=c("packages and data", "merge data", "growthrates")}
#set up data
...
```{r models_simple, echo=FALSE, warning=FALSE, dependson=c("packages and data", "merge data", "growthrates", "models"), eval=FALSE, include=FALSE}
...
```{r models_base, echo=FALSE, dependson=c("packages and data", "merge data", "growthrates", "models"), eval=FALSE, include=FALSE}
