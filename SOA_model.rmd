...
```{r models_gamm_autocorr_1, include=FALSE, warning=TRUE}
...
```{r models_gamm_autocorr_2, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
...
```{r models_gamm_autocorr_3, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
...
```{r models_gamm_autocorr_4, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
...
```{r models_gamm_autocorr_5, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
...
```{r models_gamm_autocorr_6, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
...
```{r models_gamm_autocorr_7, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
...
```{r models_gamm_autocorr_7b, include=FALSE, warning=TRUE}
acfplotfun(mod1) #examine the autocorrelation
# https://www.analyticsvidhya.com/blog/2015/12/complete-tutorial-time-series-modeling/ for a good discussion of how to interpret these plots, and whether there is AR or MA correlation
## if it seems like like sharp cut-off in ACF and PACF - AR terms probably best
## if it seems like ACF drops off slowly - ARMA terms probably best
