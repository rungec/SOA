...
```{r randomplots, include=TRUE, warning=TRUE, fig.height=6, fig.width=8}
...
```{r modelsgam, include=TRUE, warning=TRUE, fig.height=6, fig.width=12}
...
```{r models_gamm, include=TRUE, warning=TRUE}
################
#Main processing
################
industries <- unique(znormdat$subIndustry)
