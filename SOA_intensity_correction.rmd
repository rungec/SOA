...
intensitydf <- alldat %>%  filter(!is.na(value) & !Industry %in% c("OilandGas", "Mining")) %>% #drop years missing data
...
intensitydf <- bind_rows(intensitydf, oilintensity, miningintensity)
